  ...
  return (
    <div className="min-h-screen bg-[#030509] bg-grid relative overflow-x-hidden">
      ...
      >
        <div className="max-w-[1400px] mx-auto px-4 py-3 flex flex-wrap items-center gap-3">
          ...
          >
            {VISUALIZATION_MODES.map(vm => (
              <button
                ...
                onClick={() => {
                  setMode(vm.key)
                  if (vm.key !== 'standard') setActiveCategoryId(null)
                }}
                className="text-[11px] font-medium px-2.5 py-1.5 rounded-md transition-all duration-200 whitespace-nowrap"
                style={mode === vm.key
                  ? { background: '#00d4ff', color: '#030509', fontWeight: 700, boxShadow: '0 0 12px rgba(0,212,255,0.4)' }
          ...
          <div className="relative ml-auto">
            ...
            <input
              ...
              className="pl-8 pr-8 py-2 rounded-lg text-[12px] text-white placeholder-white/25 outline-none transition-all duration-200 w-36 focus:w-52"
              style={{
          ...
          <button
            ...
            style={statsOpen
              ? { color: '#00d4ff', background: 'rgba(0,212,255,0.1)', borderColor: 'rgba(0,212,255,0.3)' }
              : { color: 'rgba(255,255,255,0.4)', background: 'rgba(255,255,255,0.03)', borderColor: 'rgba(255,255,255,0.07)' }
            }
        ...
        {statsOpen && (
          <div
            className="max-w-[1400px] mx-auto px-4 pb-3 flex flex-wrap gap-3"
          ...
          >
            {[
              ...
              <div key={s.label} className="flex items-center gap-1.5 mt-2">
